...
public class Time {
	...
	public Long buscaMelhorJogador() {
		return this.jogadores
				.entrySet()
				.stream()
				.max(Map.Entry.comparingByValue((jog1, jog2) -> jog1.getNivelHabilidade().compareTo(jog2.getNivelHabilidade())))
				.get()
				.getKey();
	}
	...
	public Long buscaJogadorMaisVelho() {
		return this.jogadores
				.entrySet()
				.stream()
				.max(Map.Entry.comparingByValue((jog1, jog2) -> jog1.comparaDataNascimento(jog2)))
				.get()
				.getKey();
	}
	...
	public Long buscaJogadorMaiorSalario() {
		return this.jogadores
				.entrySet()
				.stream()
				.max(Map.Entry.comparingByValue((jog1, jog2) -> jog1.comparaSalario(jog2)))
				.get()
				.getKey();
	}
